...
var qstHead;
var groups;
var quizTitle="aku sayang kamu";
var printCpRg=1;
var filename = 'sayang kamu';

var topChartFile='';
var pesi;
var allAnsReport;
var author  = 'admin juara';
var mediaDir  = 'media';
var cssDir  = 'css';
...
function completeInitValuate() {
 if (frames.quiz_main.currPage==0) {
   if (valid[0]==0) {
     ...
     StoreAnswer(0);    }
   frames.quiz_main.location.href="sayang kamuQ2.htm" }
 if (frames.quiz_main.currPage==1) {
   if (valid[1]==0) {
     ...
     StoreAnswer(1);    }
   frames.quiz_main.location.href="sayang kamuQ3.htm" }
 if (frames.quiz_main.currPage==2) {
   if (valid[2]==0) {
     ...
     StoreAnswer(2);    }
   frames.quiz_main.location.href="sayang kamuQ4.htm" }
...
function initShortQuestion() {
 qstHead[0]="pentol bakso terbuat dari ...";
 qstHead[1]="jumlah kaki ayam ada ...";
 qstHead[2]="  angka berapa ini ...";
 qstHead[3]="mana gambar angka 5";
}
...
function SendResults() {
 sendwin = ManageDialog(CreateDialog('mysendwin','sayang kamu4.htm',400,320));
}
function goes() {
  setTimeout('goes_delayed()',500);
}
...
function endConnTimeout()
{
  clearTimeout(connTimer);
  var btn1 = frames.quiz_main.document.getElementById('btnResults');  var btn2 = frames.quiz_main.document.getElementById('btnResultsDisabled');  if (btn1!=null) btn1.className = 'btnShow';
  if (btn2!=null) btn2.className = 'btnHide';
}
...
function Constructor() {
  ...
  typeOfQuest = new init_array(1,1,1,1);
